                        ...
                        child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                ...
                                return "Eingabe zu lnag";
                              } else if (int.parse(value) > 31) {
                                return "Tag unplausibel";
                              }
                            })),
                    const SizedBox(
                        ...
                        child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                ...
                                return "Monat darf maximal 12 betragen.";
                              }
                            })),
                    const SizedBox(
                        width: AppPaddings.paddingInputFieldsStandard),
                        ...
                        child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                ...
                                return "Jahr muss 4 Zahlen beinhalten";
                              }
                            }))
                  ])),
              Padding(
                  ...
                  child: TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return "Bitte Gewicht eintragen";
                        }
                      })),
              Padding(
                  padding: const EdgeInsets.all(
